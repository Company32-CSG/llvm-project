...
struct DoccamContext {
  ...
  SymbolStyle PreferredSymbolStyle = SymbolStyle::Glyph;
  ...
  DoccamContext(DoccamContextParameters Params) {
    ...
    if (isDoccamContextSymbolStyleSet(EffSymStyle,
                                      DoccamContextSymbolStyle::Codicon))
      PreferredSymbolStyle = SymbolStyle::Codicon;
    else if (isDoccamContextSymbolStyleSet(EffSymStyle,
                                           DoccamContextSymbolStyle::Emoji))
      PreferredSymbolStyle = SymbolStyle::Emoji;
    else if (isDoccamContextSymbolStyleSet(EffSymStyle,
                                           DoccamContextSymbolStyle::Glyph))
      PreferredSymbolStyle = SymbolStyle::Glyph;
  }
};
