...
const std::vector<DoccamTag> TagList = {
	...
	{ TagType::Example, TagParsingFlags(false, true, true), "example", "Example usage code block: @example[<lang>] ... @end", { "usage" } },
...
bool
isDoccamTagInitiator(std::string_view Contents)
{
...
const DoccamTag*
getDoccamTagByName(std::string_view Name)
{
