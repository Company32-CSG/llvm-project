...
struct CodeCompleteOptions
{
	...
	std::function<void(const CodeCompletion&, const SymbolQualitySignals&, const SymbolRelevanceSignals&, float Score)>
		RecordCCResult;
...
CodeCompleteResult codeCompleteFlowHook(PathRef FileName, size_t Offset, const PreambleData* Preamble, const ParseInputs& ParseInput, CodeCompleteOptions Opts, SpeculativeFuzzyFind* SpecFuzzyFind, std::string_view PatchedContents);
